...
var setchat = BASE_URL+'chat/chatfiles/setchat.php';           // file accesed when add chat, or actualise user
var getchat = function() {return 'chat/chattxt/'+chatroom+'.txt';};       // TXT file with chat content of current room
...
function setHtmlChat(objChat) {
  ...
  if((refresh_usrs % 2) == 0) {
    ...
    if(document.getElementById('chatusers')) document.getElementById('chatusers').innerHTML = chatusers;     // update chat users
  }
  refresh_usrs++;
}
