...
<div class="panel-heading"><h3 class="panel-title">Edit mapel</h3></div>
    <div class="panel-body"> 
        ...
        <div class="row clearfix">
        	...
        	<form class="form-horizontal" role="form" method="post" action="">            
              <?php echo form_text("Nama mapel","mapel_nama", $row['mapel_nama']);?>
              <?php echo form_button("SIMPAN","edit_mapel");?>      
            </form>
